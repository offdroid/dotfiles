return require'packer'.startup({
    function(use)
        ...
        use {
            'hrsh7th/nvim-cmp',
            requires = {
                'hrsh7th/cmp-vsnip', 'hrsh7th/cmp-buffer',
                'hrsh7th/cmp-nvim-lsp', 'hrsh7th/cmp-calc', 'hrsh7th/cmp-path',
                'hrsh7th/vim-vsnip'
            }
        }
        use {
        ...
        -- Cosmetic
        use {'ryanoasis/vim-devicons', after = 'github-nvim-theme'}
        ...
        use { -- Status line
            ...
            requires = {'kyazdani42/nvim-web-devicons', 'github-nvim-theme'}
        ...
        use {'marko-cerovac/material.nvim', after = 'packer.nvim'}
        ...
        use {
            ...
            config = function()
                ...
                vim.api.nvim_set_var('matchup_matchparen_deferred_show_delay',
                                     200)
            end,
            event = 'CursorMoved',
            disable = true
        ...
        use {
            ...
            config = function()
                -- vim.g.surround_prefix = '<leader>k'
